      ...
      <div className="contactSection ">
        ...
        <div className="mt-4 px-16">
          ...
          <div className="flex  flex-col min-w-full justify-center items-center gap-4 mt-4 mb-4 relative">
            <img src={logo} alt="Bharat Logo" className="w-[30%] h-13" />
            <div className="relative w-full h-[30vh] ">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 rounded-lg">
                <h1 className="text-white text-3xl font-bold z-50">
          ...
          <div className="contactUsLogo flex justify-between mt-8 mb-8 px-10 ">
            ...
            <div className="flex items-center flex-col gap-2">
              ...
              <h1 className="text-2xl font-semibold">Mail Us</h1>
              <a
                href={gmailLink}
                target="_blank"
                ...
                className="text-xl"
              >
                bharat.mechsolutions@gmail.com
              </a>
            </div>
          </div>
        </div>
